...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="md:col-span-2 bg-white p-6 rounded-lg shadow-lg">
            ...
            <ul class="space-y-4">
                ...
                <li class="flex justify-between items-center border-b pb-4">
                    <div class="flex items-center gap-4">
                        <img src="{{ asset($item['gambar']) }}" alt="{{ $item['nama_produk'] }}" class="w-20 h-20 object-cover rounded-lg">
                        <div>
                    ...
                    @php
                        $totalHarga += $item['harga'] * $item['quantity']; // Tambahkan harga total
                    @endphp
                </li>
                @endforeach
            </ul>
            <div class="mt-6 border-t pt-4">
                ...
                <div class="flex justify-between items-center mt-2">
                    ...
                    <p class="font-bold text-gray-900 text-lg">Rp. {{ number_format($totalHarga, 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
            ...
            <h2 class="text-lg font-semibold text-gray-700 mb-4">Informasi Pengiriman</h2>
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" required
                           class="w-full border-gray-300 rounded-lg mt-1 p-2 focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea id="address" name="address" required rows="3"
                              class="w-full border-gray-300 rounded-lg mt-1 p-2 focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                </div>
                <div class="flex justify-end">
                    <button type="submit" 
                            class="bg-indigo-600 hover:bg-indigo-800 text-white px-6 py-2 rounded-lg font-semibold">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg text-center">
        ...
        <a href="{{ route('user') }}" class="text-indigo-600 hover:underline">Kembali Belanja</a>
    </div>
    @endif
</div>
</x-app-layout>
